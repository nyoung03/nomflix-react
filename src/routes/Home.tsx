...
import { getNowMovies, IGetNowMovies } from "./api";
...
function Home() {
  ...
  const { data: nowPlay, isLoading: nowPlayIsLoading } =
    useQuery<IGetNowMovies>([catagories.nowPlay, "nowPlaying"], getNowMovies);
  ...
  const incraseIndex = (catagory: string, data: any) => {
    if (nowPlay) {
      ...
      if (catagory === catagories.nowPlay) {
      ...
      {nowPlayIsLoading ? (
        ...
        <>
          ...
          >
            ...
            <Overview>{`${nowPlay?.results[0].overview.slice(
              0,
              192
            )}...`}</Overview>
          </Banner>
          <Slider>
            ...
            <Arrow
              onClick={() => incraseIndex(catagories.nowPlay, nowPlay)}
            ...
            <Arrow
              onClick={() => decreaseIndex(catagories.nowPlay, nowPlay)}
